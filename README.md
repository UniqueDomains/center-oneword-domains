...
> **Important:** this repository is a **public 8,280-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **8,281 domains** on the canonical page below.

**Public extract:** 8,280 rows · **Live catalog:** 8,281 domains
...
| ----------------------- | ------------------------------------------------ |
| 8,280-row public sample | 8,281 live domains                               |
