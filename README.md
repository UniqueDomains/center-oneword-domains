...
**Public extract:** 8,281 rows · **Live catalog:** 8,281 domains
...
- `center.csv` — public CSV extract (8,281 rows)
- `center.json` — public JSON extract (8,281 rows)
...
| abstract.center  | available | $7.99     | $41.99        | 108            | 30     | 8      | name.com                                     |
...
| four.center      | available | $7.99     | $41.99        | 66             | 29     | 4      | name.com                                     |
...
| ----------------------- | ------------------------------------------------ |
| 8,281-row public sample | 8,281 live domains                               |
...
> Unique Domains. *Available .CENTER One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
