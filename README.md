# Available .CENTER One-Word Domains (8,271)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C275%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C271%20domains-6f42c1">
...
**Public extract:** 8,275 rows · **Live catalog:** 8,271 domains
...
- `center.csv` — public CSV extract (8,275 rows)
- `center.json` — public JSON extract (8,275 rows)
...
| bad.center       | resell    | —         | —             | 142            | 99     | 3      | Automattic Inc.                              |
| all.center       | premium   | $82.50    | $82.50        | 88             | 48     | 3      | name.com                                     |
| wiz.center       | available | $7.99     | $41.99        | 80             | 31     | 3      | name.com                                     |
| black.center     | resell    | —         | —             | 100            | 98     | 5      | Sav.com, LLC                                 |
| elite.center     | premium   | $250      | $250          | 90             | 43     | 5      | name.com                                     |
| trinity.center   | available | $7.99     | $41.99        | 72             | 31     | 7      | name.com                                     |
| balanced.center  | resell    | —         | —             | 74             | 97     | 8      | Dynadot Inc                                  |
| about.center     | premium   | $26       | $26           | 94             | 38     | 5      | namecheap                                    |
...
| like.center      | premium   | $500      | $500          | 84             | 36     | 4      | name.com                                     |
...
| ----------------------- | ------------------------------------------------ |
| 8,275-row public sample | 8,271 live domains                               |
...
> Unique Domains. *Available .CENTER One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
