# Available .CENTER One-Word Domains (11,960)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-11%2C960%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **11,960 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 11,960 domains · **Median ask:** $10.02 · **High-demand under $2,500:** 0
...
| special.center | resell    | —         | —             | high           | low    | 7      | DNSPod, Inc.                                 |
| attack.center  | premium   | $23.60    | $23.60        | high           | low    | 6      | namesilo                                     |
| heavy.center   | available | $7.99     | —             | high           | low    | 5      | name.com                                     |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 11,960 live domains                        |
...
This list gathers 11,002 one-word domain names registered under the .center extension, with a median asking price near $12. The set ranges from tight single words like Acup.center and Hightech.center to compact compounds such as CoffeeCake.center and GetTogether.center, giving both founders and investors a broad pool of short, ownable names to compare on price, length, and brand fit.

- 11,002 one-word .center names, updated daily
- Median asking price near $12 across the set
- Short, brandable strings ownable now
- Compare pricing and renewal before you choose
...
> Unique Domains. *Available .CENTER One-Word Domains*. Version 2026-08-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
