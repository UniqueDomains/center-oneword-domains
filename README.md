# Available .CENTER One-Word Domains (8,281)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C279%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C281%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,279-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **8,281 domains** on the canonical page below.

**Public extract:** 8,279 rows · **Live catalog:** 8,281 domains
...
- `center.csv` — public CSV extract (8,279 rows)
- `center.json` — public JSON extract (8,279 rows)
...
| simply.center    | resell    | $7.99     | —             | 68             | 42     | 6      | Sav.com, LLC                                        |
...
| elite.center     | premium   | $250      | $250          | 90             | 43     | 5      | name.com                                            |
...
| wicked.center    | available | $7.99     | $41.99        | 70             | 30     | 6      | name.com                                            |
...
| wise.center      | resell    | —         | —             | 98             | 72     | 4      | Chengdu West Dimension Digital Technology Co., Ltd. |
...
| ----------------------- | ------------------------------------------------ |
| 8,279-row public sample | 8,281 live domains                               |
...
> Unique Domains. *Available .CENTER One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
